...
import { generateDebugLog, formatDebugLogForEmail, createEmailWithDebugLog, initializeDebugLogging } from '../services/debugLog';
...
const DebugLogComponent: React.FC<DebugLogProps> = ({ onClose }) => {
  ...
  useEffect(() => {
    // Initialize debug logging if not already initialized
