export type EnergyLevel = '10s' | '10s-reset' | '10s-anchor' | '10s-hum' | '2min' | '5min' | 'custom';
export type AppView = 'loading' | 'terms' | 'settings' | 'values' | 'welcome' | 'breathing' | 'conversation' | 'crisis-resources' | 'help' | 'sessions' | 'complete';
