...
export default function App() {
  ...
  const [selectedTenSecondBreaker, setSelectedTenSecondBreaker] =
    useState<EnergyLevel>("10s-reset");
  ...
  const handleWelcomeInput = async () => {
    ...
    try {
      ...
      setConversationHistory((prev) => [
        ...prev,
        { role: "assistant", content: "I'm still here. Take your time." },
      ]);
    }
    setAiLoading(false);
  };
  ...
  const handleComplete = () => {
    ...
    localStorage.setItem(
      "grounded_moments",
      JSON.stringify(new Array(updated).fill({})),
    );
    setView("complete");
  };
    ...
    <div className="app-stage" style={styles.helpContainer}>
      ...
      <div style={styles.helpSection}>
        <div style={styles.helpItem}>
          ...
          <div style={styles.helpContent}>
            ...
            <p style={styles.helpText}>
              ...
              provides a different breathing exercise tailored to your current
              state.
            </p>
          </div>
        </div>
        ...
        <div style={styles.helpItem}>
          ...
          <div style={styles.helpContent}>
            ...
            <p style={styles.helpText}>
              A calming animation will guide you through breathing. Follow along
              at your own pace. This helps ground you before our chat.
            </p>
          </div>
        </div>
        ...
        <div style={styles.helpItem}>
          ...
          <div style={styles.helpContent}>
            ...
            <p style={styles.helpText}>
              Share what's on your mind. Our AI listens without judgment and
              helps you work through difficult emotions privately.
            </p>
          </div>
        </div>
        ...
        <div style={styles.helpItem}>
          ...
          <div style={styles.helpContent}>
            ...
            <p style={styles.helpText}>
              Save your chat for later reference, or share it with someone you
              trust. All data stays on your device—nothing is sent to servers.
            </p>
          </div>
        </div>
        ...
        <div style={styles.helpItem}>
          ...
          <div style={styles.helpContent}>
            ...
            <p style={styles.helpText}>
              Tap the sun/moon icon to switch themes. Perfect for nighttime use
        ...
        <div style={styles.helpItem}>
          ...
          <div style={styles.helpContent}>
            ...
            <p style={styles.helpText}>
              If you're in crisis, the Crisis tab provides immediate access to
      ...
      <div style={styles.helpFooter}>
        <p style={styles.helpFooterText}>
          💡 Grounded runs entirely on your device. Your conversations are never
          seen by anyone else.
        </p>
      </div>
    </div>
  ...
  const renderSessions = () => {
    const sessionsForDate = savedSessions.filter(
      (s) => s.dateString === selectedDate,
    );
  ...
  const [headerHover, setHeaderHover] = useState<"theme" | "settings" | null>(
    null,
  );
      ...
      <div style={styles.footerInputContainer}>
        ...
        <button
          style={{
            ...
            opacity: pendingUserInput.trim() ? 1 : 0.5,
          }}
    ...
    <div style={styles.container}>
      ...
      <div style={styles.unsupportedContent}>
        <p style={styles.unsupportedText}>
          Grounded uses WebGPU for privacy-first, offline AI conversations.
          Safari doesn't support WebGPU yet.
        </p>
        ...
        {!showFullTerms ? (
          <div style={styles.termsSummary}>
            ...
            >
              ...
              <p style={styles.termsCardText}>
                AI runs locally. No data leaves your device.
              </p>
            </button>
            <button
              style={styles.termsCard}
            ...
            >
              ...
              <p style={styles.termsCardText}>
                TinyLlama runs on your device for privacy.
              </p>
            </button>
            <button
              style={styles.termsCard}
  ...
  const renderValues = () => {
    ...
    return (
      <div style={styles.container}>
        ...
        <p style={styles.valuesIntro}>
          What matters most to you? Tap to select or deselect.
        </p>
        {selections.length > 0 && (
          <div style={styles.valuesSummary}>
            <h3 style={styles.valuesSummaryTitle}>
  ...
  const renderCrisisResources = () => (
    <div style={styles.container}>
      ...
      <div style={styles.crisisUrgent}>
        ...
        <p style={styles.crisisUrgentText}>
      ...
      {[
        ...
        },
        {
          ...
          desc: "LGBTQ+ support",
          phone: "tel:1-866-488-7386",
        },
        {
          name: "Veterans Crisis Line",
          desc: "Call 988, press 1",
          phone: "tel:988",
        },
      ].map((item) => (
        <div key={item.name} style={styles.crisisCard}>
          ...
          <a href={item.phone} style={styles.crisisCallButton}>
            Call
          </a>
        </div>
      ))}
  ...
  const renderConversation = () => {
    const nodeData = conversationState
      ? getConversationNode(conversationState.node)
      : null;
    const quickReplies =
      nodeData && "quickReplies" in nodeData
