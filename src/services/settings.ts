...
export interface UserStats {
  [sessionKey: string]: number | string | undefined; // Count of completions per session or string metadata
...
export function trackCompletion(sessionKey: string): void {
  try {
    ...
    stats[sessionKey] = (typeof stats[sessionKey] === 'number' ? stats[sessionKey] as number : 0) + 1;
