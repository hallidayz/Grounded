...
export interface UserStats {
  [sessionKey: string]: number | string | undefined; // Count of completions per session, plus standard stats
...
export function trackCompletion(sessionKey: string): void {
  try {
    ...
    const currentSessionCount = typeof stats[sessionKey] === 'number' ? stats[sessionKey] as number : 0;
